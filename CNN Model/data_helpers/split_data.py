...
#--> Load data <--
#-----------------
#in_file = pd.read_csv(r'/home/raj/mntShare/share/stream-2000k.csv', encoding='latin-1')

in_file='/home/raj/mntShare/share/deep-learning-for-big-crisis-data-master/data/prccd_folder/india_floods_prccd.csv'

with open(r'/home/raj/mntShare/share/deep-learning-for-big-crisis-data-master/data/prccd_folder/india_floods_prccd.csv', 'rU') as fin:
	i=np.array([])
	X=np.array([])
	y=np.array([])
        rows = csv.reader(fin)
